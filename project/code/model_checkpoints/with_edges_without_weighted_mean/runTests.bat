...
call python main_fullEval.py "--fe_name=%currDirName%" "--fe_sub_name=alpha1_dd20_dv2" "--cl_name=''" "--cl_sub_name=''" "--fe_epoch_num=101" "--cl_epoch_num=0" "--output_path=%currDirFullPath%\alpha1_dd20_dv2\initial_check"
