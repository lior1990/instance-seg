...
def train_argument_parser():
    ...
    default_train_data_path = os.path.join('..', '..', 'cvppp', 'formattedA1Only', 'train2', 'mask_distances_no_edges_yes_weighted_mean', '')
    ...
    default_train_labels_path = os.path.join('..', '..', 'cvppp', 'formattedA1Only', 'train2', 'mask_labels_no_edges_yes_weighted_mean', '')
    ...
    default_train_ids_file = os.path.join('..', '..', 'cvppp', 'formattedA1Only', 'train2', 'mask_ids_no_edges_yes_weighted_mean.txt')
